        ...
        <>
            <div className="w-full bg-neutral-900 shadow-inner flex-grow relative overflow-hidden group">
                ...
                {status === 'done' && imageUrl && (
                    <>
                        ...
                        {onPrev && (
                            <div className={cn(
                                "absolute top-1/2 -translate-y-1/2 left-2 z-20 flex items-center transition-opacity duration-300",
                                !isMobile && "opacity-0 group-hover:opacity-100",
                        ...
                        {onNext && (
                             <div className={cn(
                                "absolute top-1/2 -translate-y-1/2 right-2 z-20 flex items-center transition-opacity duration-300",
                                !isMobile && "opacity-0 group-hover:opacity-100",
                             )}>
                                <button
            ...
            <div className="absolute bottom-4 left-4 right-4 text-center px-2">
                 <div className="flex items-center justify-center gap-2">
                    ...
                    {(status === 'done' || status === 'error') && totalImages > 1 && (
                         <span className="font-sans text-xs bg-black/10 text-neutral-700 rounded-full px-2 py-0.5 flex-shrink-0">
